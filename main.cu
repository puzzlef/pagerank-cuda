...
void runPagerank(const G& x, const H& xt, int repeat) {
  ...
  for (int i=0; i<=20; i++) {
    ...
    auto a1 = pagerankNvgraph(xt, init, {repeat, tolerance});
    ...
    auto a2 = pagerankCuda(xt, init, {repeat, tolerance, L1});
    ...
    auto a3 = pagerankSeq(xt, init, {repeat, tolerance, L1});
    ...
    auto a4 = pagerankCuda(xt, init, {repeat, tolerance, L2});
    ...
    auto a5 = pagerankSeq(xt, init, {repeat, tolerance, L2});
    ...
    auto a6 = pagerankCuda(xt, init, {repeat, tolerance, Li});
    ...
    auto a7 = pagerankCuda(xt, init, {repeat, tolerance, Li});
