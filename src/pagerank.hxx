...
// For pagerank cuda switched-per-vertex (default)
template <class T=float>
...
struct PagerankOptions {
  ...
  PagerankOptions(int repeat=1, int gridLimit=GRID_DIM_PRB<T>(), int blockSize=BLOCK_DIM_PRB<T>(), T damping=0.85, T tolerance=1e-6, int maxIterations=500) :
