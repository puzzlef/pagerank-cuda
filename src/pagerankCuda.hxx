...
template <class G, class C, class T=float>
PagerankResult<T> pagerankCuda(G& xt, const vector<T> *q=nullptr, PagerankOptions<T> o=PagerankOptions<T>()) {
  int G = o.gridSize;
  int B = o.blockSize;
  T   p = o.damping;
  T   E = o.convergence;
