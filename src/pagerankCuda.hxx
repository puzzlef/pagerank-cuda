...
template <class T>
void pagerankBlockCu(T *a, const T *c, const int *vfrom, const int *efrom, int i, int n, T c0, const PagerankOptions<T>& o) {
  int B = o.blockSize;
...
void pagerankSwitchedCu(T *a, const T *c, const int *vfrom, const int *efrom, int i, J&& ns, T c0, const PagerankOptions<T>& o) {
  for (int n : ns) {
    if (n>0) pagerankBlockCu (a, c, vfrom, efrom, i,  n, c0, o);
...
int pagerankCudaLoop(T *e, T *r0, T *eD, T *r0D, T *&aD, T *&rD, T *cD, const T *fD, const int *vfromD, const int *efromD, const int *vdataD, int i, J&& ns, int N, T p, T E, int L, const PagerankOptions<T>& o) {
  ...
  for (; l<L; l++) {
    ...
    pagerankSwitchedCu(aD, cD, vfromD, efromD, i, ns, c0, o);
    l1NormCu(eD, rD, aD, n);
...
PagerankResult<T> pagerankCuda(const H& xt, const vector<T> *q=nullptr, PagerankOptions<T> o=PagerankOptions<T>()) {
  ...
  float t = measureDurationMarked([&](auto mark) {
    ...
    mark([&] { l = pagerankCudaLoop(e, r0, eD, r0D, aD, rD, cD, fD, vfromD, efromD, vdataD, 0, ns, N, p, E, L, o); });
  }, o.repeat);
